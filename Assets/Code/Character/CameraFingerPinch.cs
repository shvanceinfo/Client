...
public class CameraFingerPinch : MonoBehaviour
{
	...
	private void On_PinchIn(Gesture gesture){
        ...
        if (EasyTouchJoyStickProperty.sJoystickProperty.gameObject.activeSelf)
        {
            float zoom = Time.deltaTime * gesture.deltaPinch * CameraFollow.sCameraFollow.m_fZoomSpeed;
            zoom = Mathf.Clamp01(zoom);
            CameraFollow.sCameraFollow.m_fZoomPinchValue += zoom;
        }
	}
