...
public class Joystick : MonoBehaviour
{
    ...
    void ResetJoystick()
    {
        ...
        if (touchPad)
        {
            gui.color = new UnityEngine.Color(gui.color.r, gui.color.g, gui.color.b, 0.025f);
            //gui.color.a = 0.025f;	
        }
	    ...
	    else
	    {
		    for( int i = 0;i < count; i++)
		    {
			    ...
			    if ( shouldLatchFinger && ( lastFingerId == -1 || lastFingerId != touch.fingerId ) )
			    {
				    ...
				    if ( touchPad )
				    {
                        gui.color = new UnityEngine.Color(gui.color.r, gui.color.g, gui.color.b, 0.15f);
					    //gui.color.a = 0.15f;
			    ...
			    {	
				    ...
				    {					
                        ...
                        UnityEngine.Rect tmpRect = new UnityEngine.Rect(gui.pixelInset.left, gui.pixelInset.top, gui.pixelInset.width, gui.pixelInset.height);
