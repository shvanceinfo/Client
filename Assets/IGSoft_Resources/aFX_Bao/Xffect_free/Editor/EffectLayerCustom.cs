...
public class EffectLayerCustom : Editor
{
   ...
   // protected SerializedProperty RopeUVStretch;
    ...
    void DrawShaderController()
    {
        ...
        string shaderName = Script.Material.shader.name;
        ...
        XEditor.BeginXArea("Advance Shader Control", XArea, XEditorTool.MinHeight, XEditorTool.EArea.AlwaysToggle, null, 1f);
    ...
    void DrawColorConfig()
    {
        ...
        {
            DrawColorParam(m, Script.RandomColorParam, ref GradientTex2);
        }
        else
        {
        ...
        if ((COLOR_CHANGE_TYPE)ColorChangeType.enumValueIndex == COLOR_CHANGE_TYPE.Gradient)
        {
            ...
            DrawColorParam(m, Script.ColorParam, ref GradientTex);
        }
        XEditor.EndXArea();
    }
    ...
    void DrawAffectors()
    {
        ...
        XEditor.DrawInfo("check to activate, uncheck to disable.");
    ...
    void DrawRope()
    {
        XEditor.BeginXArea("Rope", XArea, XEditorTool.MinHeight, XEditorTool.EArea.AlwaysToggle, null);
